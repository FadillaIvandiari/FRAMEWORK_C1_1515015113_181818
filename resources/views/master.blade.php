...
<body>
    ...
    <div class="container">
      ...
      <div class="container">
              <div class="content">
                  <div class="title">WELCOME TO PRAKTIKUM PEMROGRAMAN FRAMEWORK<br>
                  FADILLA IVANDIARI / 1515015113</div>
                  </div>
                </div>
            <div>
      ...
      <nav class="navbar navbar-default navbar-fixed-bottom">
        <footer class="container">
          created by <a href="https://instagram.com/Ivandiari"><span><i class="fa fa-instagram" style"color#1da1f2"></i>@Ivandiari</span></a>
        </footer>
      </nav>
